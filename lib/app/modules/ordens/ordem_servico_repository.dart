...
class OrdemServicoRepository extends BaseRepository<OrdemServico> {
  ...
  OrdemServicoRepository({
    super.supabase, super.databaseHelper, super.offlineSyncService,
  ...
  Future<String> salvarComEvidencias(OrdemServico ordem, {Uint8List? fotoAntes, Uint8List? fotoDepois, Uint8List? assinatura}) async {
    ...
    if (hasEvidence && await ConnectivityHelper.isOnline()) {
      ...
      ordemFinal = ordemFinal.copyWith(fotoAntesPath: uploaded['fotoAntesPath'], fotoDepoisPath: uploaded['fotoDepoisPath'], assinaturaBase64: uploaded['assinaturaBase64']);
    } else if (hasEvidence) {
      ordemFinal = ordemFinal.copyWith(
        fotoAntesPath: fotoAntes == null ? null : 'data:image/jpeg;base64,${base64Encode(fotoAntes)}',
        fotoDepoisPath: fotoDepois == null ? null : 'data:image/jpeg;base64,${base64Encode(fotoDepois)}',
        assinaturaBase64: assinatura == null ? null : 'data:image/png;base64,${base64Encode(assinatura)}',
      );
    }
